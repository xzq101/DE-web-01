const pyclass = [
  {
    ...
    description: [
      {
        p:
          "本课程将完整的讲述经典力学的基础知识，以及基本的分析物理问题的方法和思路。力学课程内容是根据AP Physics 1 的考察知识点来设计的。学生学习结束以后可以轻松应付AP Physics 1的考试。由于AP Physics C的考察点和AP Physics 1很接近。对于学过微积分的高年级学生可以直接参加AP Physics C: Mechanics 的考试。对于有志于继续参加物理竞赛的学生，该课程可以帮助建立严谨的物理思维，为以后求解更难的题目打好基础。",
      },
      {
        p:
          "本课程大约一半的时间用来讲解物理原理和物理公式，另一半的时间用来详细讲解作业。每次课课后会布置10-20道 AP Physics 1 的真题作为练习。所有的AP真题会在习题课详细解答，锻炼学生能有效，准确的写出求解过程。",
      },
      {
        p:
